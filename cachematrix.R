## There are two functions below that are used to create a special matrix object
...
makeCacheMatrix <- function(x = matrix()) {
    ...
    get <- function() x
    setinv <- function(inverse_=NULL) inv <<- inverse_
    getinv <- function() inv 
...
## the above makeCacheMatrix function. However, it first checks to see if the inverse has already been 
